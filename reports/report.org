...
As displayed in Figure \ref{fig:adult_german_yaleb}, our results for Adult and
German are similar to those obtained by cite:sarhan2020fairness, while the
results for YaleB are highly dissimilar; our target predictor attains an
accuracy of around 20\%, while Sarhan et al. attained around 90\%.
#+END_EXPORT
...
line with what cite:sarhan2020fairness report.  The relatively large
...
what citep:sarhan2020fairness reported for German, but only for particular
