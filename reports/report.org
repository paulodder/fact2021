...
invariant towards a particular (sensitive) feature. The eficacy of this
...
that are to be modelled. For detailed information about the datasets such as
...
attain 50\% accuracy, in our case this is around 50\%. Unfortunately, Sarhan et
al. provided sufficient information to be able to replicate the ratios
mentioned in the reference paper. Consequently, we constructed our own
sensitive attributes based on a similar process.
