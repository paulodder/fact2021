...
+--------+-----------------------------------------+-------------------------------+
|dataset |                 encoder                 |         discriminator         |
+--------+----------+------+-----------+-----------+-------------+------+----------+
|        | network  |hidden|activation |z-dim      |   network   |hidden|activation|
|        |          |layers|fucntion   |           |             |layers|function  |
+--------+----------+------+-----------+-----------+-------------+------+----------+
| Tabular|   MLP    | 64   | ReLU      | 2         |  Logistic   | -    | -        |
|        |          |      |           |           | Regression  |      |          |
+--------+----------+------+-----------+-----------+-------------+------+----------+
| CIFAR  |ResNet-18 | -    | -         | 128       |     MLP     | 256, | ReLU     |
|        |          |      |           |           |             |128   |          |
+--------+----------+------+-----------+-----------+-------------+------+----------+
| YaleB  |   MLP    | 100  | ReLU      | 100       |     MLP     | 100, | ReLU     |
|        |          |      |           |           |             |100   |          |
+--------+----------+------+-----------+-----------+-------------+------+----------+
